	...
	if(isset($_POST['delete']))
   {
	...
	if(isset($_POST['add']))
	{
      ...
      echo "<form name='delete' method='post' action='contacts.php' style='display: inline-block; margin-right: 25px;'>"; 
		echo "<button type='submit' name='idtodelete' value='".$row2['id']."' style='margin-right:10px;'> <image style='width:14px;height:100px;' src='http://www.famfamfam.com/lab/icons/mini/icons/page_text_delete.gif </button>"; ; 
		echo "</form>";
